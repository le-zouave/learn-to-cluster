...
from ltc.utils import (create_logger, set_random_seed, rm_suffix,
                   mkdir_if_no_exists, build_knns)


from ltc.lgcn.models import build_model
from ltc.lgcn import build_handler
...
def main():
    ...
    cfg = Config.fromfile(os.path.join(args.config, f"{cfg_name}.py"))
